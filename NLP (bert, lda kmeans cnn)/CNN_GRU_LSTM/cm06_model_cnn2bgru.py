...
from keras.layers import Dense, Embedding, GlobalAveragePooling1D, Dropout, Activation, Bidirectional, BatchNormalization, Conv1D, MaxPool1D,  Input, concatenate, GRU
...
dropout = Bidirectional(GRU(64, return_sequences=True))(dropout)
