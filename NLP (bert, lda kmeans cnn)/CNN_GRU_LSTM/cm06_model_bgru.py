...
from keras.layers import Dense, Embedding, GlobalAveragePooling1D, GlobalMaxPool1D, Dropout, Activation, Bidirectional, BatchNormalization, Conv1D, MaxPool1D,  Input, concatenate, GRU
...
max_pool1 = Activation('relu')(embed)
max_pool1 = GlobalMaxPool1D()(max_pool1)

dropout = Bidirectional(GRU(64, return_sequences=True))(embed)
